...
const QuestionCard = ({
    ...
    <div
        ref={contentRef}
        className="mt-4 text-gray-700 bg-green-50 border-l-4 border-green-500 px-5 py-3 rounded-r-lg"
        >
            <div className="flex items-start gap-3">
                <span className="text-xs md:text-[15px] font-semibold text-green-600 leading-[18px]">
                    A
                </span>
